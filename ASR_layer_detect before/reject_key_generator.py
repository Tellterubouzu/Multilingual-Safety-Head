...
#     def predict(self, input_text, generation_config=None):
...
#             input_length = len(self.tokenizer(input_text, return_tensors="pt")["input_ids"].squeeze())

#             generated_text = self.tokenizer.decode(output, skip_special_tokens=True)
            
#             # generated_tokens = output[input_length:]  # Skip the input part
...
#                 batch_responses = self.model.predict_batch(batch_inputs, batch_size=batch_size)
...
#     generator = GenerateBlockKeywords(model_path, dataset_path, moderation=False)
